//
//  JQButtonIndefiniteAnimatedView.m
//  JQExtensions
//
//  Created by zjq on 2017/6/21.
//  Copyright © 2017年 zjq. All rights reserved.
//

#import "JQButtonIndefiniteAnimatedView.h"

@interface JQButtonIndefiniteAnimatedView ()

@property (nonatomic, strong) CAShapeLayer *indefiniteAnimatedLayer;

@end

@implementation JQButtonIndefiniteAnimatedView
...
- (CAShapeLayer*)indefiniteAnimatedLayer {
    if(!_indefiniteAnimatedLayer) {
        ...
        NSURL *url = [bundle URLForResource:@"JQExtensions" withExtension:@"bundle"];
